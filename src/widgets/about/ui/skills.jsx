    ...
    <div className="w-full md:w-1/2 h-full p-10 px-4 lg:px-10 flex flex-col items-center">
      <div className="h-24 w-24 rounded-full flex shadow-lg border border-white">
        <svg
          ...
          className="w-full h-full p-4 dark:fill-white"
          width="40"
          height="44.964"
      ...
      <div className="mb-auto mt-10 max-w-lg w-full flex flex-col items-center">
        <div className="w-fit">
          <h3 className="text-3xl uppercase text-center text-editor-dark dark:text-zinc-100">
            <span className="chonky-underline-blue">React Front-end</span>
            <br />
            Developer
          </h3>
        </div>
        ...
        <ol className="w-full justify-start text-editor-dark dark:text-zinc-100 font-mono text-lg mt-6 space-y-2 list-disc list-inside">
          <li>INT20H Kyiv</li>
          <li>IT Revolution'23 Vinnytsia</li>
        </ol>
      </div>
    </div>
  );
